...
class MealControllerTest {
    ...
    private static final String UPDATED_NAME = "anotherTestMeal";
    private static final String URL_TEMPLATE = "/meals";
    private static final String EXPECTED_CONTENT ="{\"id\":1,\"meal\":\"testMeal\"}";
    private static final String EXPECTED_CONTENT_AFTER_UPDATE ="{\"id\":1,\"meal\":\"anotherTestMeal\"}";
    ...
    @BeforeEach
    void setUp(){
        dto = new MealDto(NAME);
    }

    @Test
    @DisplayName("Сохранение meal")
    ...
    @Test
    @DisplayName("Возврат ошибки сохранения meal при неправильном маппинге")
    ...
    @Test
    @DisplayName("Обновление meal")
    void updateCourse() throws Exception {
        dto.setId(DTO_ID);
        dto.setMeal(UPDATED_NAME);
        String jsonToSave = objectMapper.writeValueAsString(dto);
    ...
    @Test
    @DisplayName("Возврат ошибки обновления meal при неправильном маппинге")
    ...
    @Test
    @DisplayName("Возврат ошибки получения meal при ненайденном meal id: "+NONEXISTENT_DTO_ID)
    ...
    @Test
    @DisplayName("Возврат ошибки удаления meal при ненайденном meal id: "+NONEXISTENT_DTO_ID)
