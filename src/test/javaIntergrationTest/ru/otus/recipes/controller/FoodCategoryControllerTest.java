...
class FoodCategoryControllerTest {
    ...
    private static final String NAME = "testFoodCategory";
    private static final String UPDATED_NAME = "anotherTestFoodCategory";
    private static final String URL_TEMPLATE = "/foodcategories";
    private static final String EXPECTED_CONTENT ="{\"id\":1,\"foodCategory\":\"testFoodCategory\"}";
    private static final String EXPECTED_CONTENT_AFTER_UPDATE ="{\"id\":1,\"foodCategory\":\"anotherTestFoodCategory\"}";
    ...
    @BeforeEach
    void setUp(){
        dto = new FoodCategoryDto(NAME);
    }

    @Test
    @DisplayName("Сохранение foodCategory")
    ...
    @Test
    @DisplayName("Возврат ошибки сохранения foodCategory при неправильном маппинге")
    ...
    @Test
    @DisplayName("Обновление foodCategory")
    void updateCourse() throws Exception {
        dto.setId(DTO_ID);
        dto.setFoodCategory(UPDATED_NAME);
        String jsonToSave = objectMapper.writeValueAsString(dto);
    ...
    @Test
    @DisplayName("Возврат ошибки обновления foodCategory при неправильном маппинге")
    ...
    @Test
    @DisplayName("Получение foodCategory")
    ...
    @Test
    @DisplayName("Возврат ошибки получения foodCategory при ненайденном foodCategory id: "+NONEXISTENT_DTO_ID)
    ...
    @Test
    @DisplayName("Удаление foodCategory")
    ...
    @Test
    @DisplayName("Возврат ошибки удаления foodCategory при ненайденном foodCategory id: "+NONEXISTENT_DTO_ID)
