...
class LevelControllerTest {
    ...
    @Test
    @DisplayName("Возврат ошибки сохранения level при неправильном маппинге")
    ...
    @Test
    @DisplayName("Возврат ошибки обновления level при неправильном маппинге")
    ...
    @Test
    @DisplayName("Возврат ошибки получения level при ненайденном level id: "+NONEXISTENT_DTO_ID)
    ...
    @Test
    @DisplayName("Возврат ошибки удаления level при ненайденном level id: "+NONEXISTENT_DTO_ID)
